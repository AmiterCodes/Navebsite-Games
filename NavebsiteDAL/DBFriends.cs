...
namespace NavebsiteDAL
{
    public class DbFriends
    {
        ...
        {
            string selectDirection = $@"(SELECT Users.*
            ...
            string sql = AllDirections(selectDirection);
        ...
        {
            return DalHelper.RowExists($"SELECT [User 1] FROM UserFriends WHERE (([User 1] = {user1} AND [User 2] = {user2}) " +
        ...
        {
            return DalHelper.Insert($"INSERT INTO UserFriends ([User 1], [User 2]) VALUES ({user1}, {user2})") != DbHelper.WriteDataError;
        }
        ...
        {
            return DalHelper.Insert($"UPDATE UserFriends SET Type = TRUE WHERE [User 1] = {user1} AND [User 2] = {user2}") > 0;
        }
        ...
        {
            string sql = selectDirection.Replace("$1", "1").Replace("$2", "2")
                         + " UNION ALL "
