...
<asp:Content ID="Content2" ContentPlaceHolderID="Navebsite" runat="server">
    <div class="settings">
        <div class="setting_tab_list" id="list">
            <a class="settings_tab" onclick="openPage('chart', this)" href="#">
                ...
                <p class="settings_tab-desc">
                    Here you can view sales and purchases charts for Navebsite Games LLC.
                </p>
            </a>
            <a class="selected settings_tab " onclick="openPage('gameListContainer', this)" href="#">
                ...
                <p class="settings_tab-desc">
                    Here you can see a list of games that need review.
                </p>
            </a>
            <a class="settings_tab" onclick="openPage('balance', this)" href="#">
                ...
                <p class="settings_tab-desc">
                    Here you can see your balance and deposit money into the bank account.
                </p>
            </a>
            <a class="settings_tab" onclick="openPage('creditCards', this)" href="#">
                <span class="settings_tab-header">
                    <i class="fab fa-cc-visa"></i>
                    Credit Cards
                </span>
                <p class="settings_tab-desc">
                    Here you can view the credit cards held by Navebsite.
                </p>
            </a>
        </div>
        ...
        <asp:Panel runat="server" ID="gameListContainer" ClientIDMode="Static">
            <div class="centering">
                <h3 class="header_secondary">Games needing review</h3>
                <NV:GameViewList runat="server" ID="gameList"/>
            </div>
            </asp:Panel>
        <asp:Panel DefaultButton="DepositButton" ClientIDMode="Static" ID="balance" runat="server">
            <div class="centering">
            Balance:
            <asp:Label Text="" CssClass="balance" ID="BalanceLabel" runat="server"/>
            <div class="tuple">
                <asp:TextBox runat="server" CssClass="input" placeholder="Amount to Deposit" ID="DepositText"/>
                <asp:Button ID="DepositButton" CssClass="button" Text="Deposit Cash" ValidationGroup="Balance" OnClick="OnClick_Deposit" runat="server"/>
            </div>
            <asp:RequiredFieldValidator ID="DepositFieldValidator" runat="server" ErrorMessage="You must put a valid amount to deposit" ControlToValidate="DepositText" ValidationGroup="Balance"/>
            <asp:RangeValidator MinimumValue="0" MaximumValue="100000" Type="Double" ErrorMessage="You must input at least 0 dollars and less than 100000 dollars" ControlToValidate="DepositText" ValidationGroup="Balance" runat="server"/>
            <h3 class="header_secondary">Transaction History</h3>
            <asp:Label Text="" ID="NoTransactionsError" runat="server"/>
            <asp:GridView runat="server" ID="TransactionHistory"></asp:GridView>
            </div>
        </asp:Panel>
            <asp:Panel DefaultButton="AddCard" ID="creditCards" ClientIDMode="Static" runat="server">
                <div class="tuple_vert">
            <h3 class="header_secondary">Credit Cards</h3>
		...
		c40.9,0,74.1,33.2,74.1,74.1v222.2C382.8,342.1,349.7,375.3,308.8,375.3z" />
					...
					C281.9,92.1,279.9,90.1,277.4,90.1z" />
                            ...
                            <div>
                                CVV:
    <asp:Label ID="svgsecurity" runat="server" />
                            </div>
                        </div>
                    </ItemTemplate>
                </asp:Repeater>
