<%@ Page Title="" Language="C#" MasterPageFile="~/Missy.Master" AutoEventWireup="true" CodeBehind="Pay.aspx.cs" Inherits="Navebsite.Pay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Navebsite" runat="server">
    <asp:Panel class="centering" ID="payment" runat="server">
        ...
        <div class="tuple_vert">
            <div class="tuple">
                <asp:Label AssociatedControlID="name" runat="server">Name</asp:Label>
                <asp:TextBox ClientIDMode="Static" CssClass="input" ID="name" MaxLength="20" type="text" runat="server"></asp:TextBox>
            </div>
            <div class="tuple">
            ...
            <div class="tuple">
                ...
                <asp:TextBox ClientIDMode="Static" ID="securitycode" CssClass="input" type="text" pattern="[0-9]*" inputmode="numeric" runat="server"></asp:TextBox>
            </div>
        </div>
    </asp:Panel>
    <div class="centering">
        ...
        <asp:Panel ID="gameOptions" Visible="false" runat="server" CssClass="tuple_vert">
            ...
            <div>
            <asp:CheckBox ClientIDMode="Static" ID="UseBalance" AutoPostBack="True" OnCheckedChanged="UseBalance_OnCheckedChanged" Checked="False" Text="Use Balance" runat="server"/>
            </div>
            <asp:Label Text="Current Balance:" CssClass="balance_title" runat="server" />
            <asp:Label ID="CurrentBalance" Text="0" CssClass="balance_value" runat="server" />
            <asp:Label Text="Remaining Balance:" CssClass="balance_title" runat="server" />
            <asp:Label ID="RemainingBalance" Text="0" CssClass="balance_value" runat="server" />
